...
function msitheme_galleries_cat_list( ) {
    $galleries = get_terms( 'gallery_cat', array('hide_empty' => true) );
    $gallery_cat_array = array();

    if ( !empty($galleries) ) {
        foreach ( $galleries as $gallery ) {
            $info = get_term($gallery, 'gallery_cat');
            $gallery_cat_array[ $info->term_id ] = $info->name;
        }
    }
    return $gallery_cat_array;
}

class Galleries extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'multiple' => true,
                'options' => msitheme_galleries_cat_list(),
            ]
        );
