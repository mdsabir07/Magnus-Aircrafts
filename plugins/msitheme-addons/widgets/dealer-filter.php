...
class DealerFilter extends Widget_Base {
	...
	public function get_title() {
		return __( 'Dealer Filter', 'msitheme' );
	}
	...
	protected function _register_controls() {
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .msitheme-dealer-filter',
			]
		);
	...
	protected function render()
	{
        ...
        echo do_shortcode( '[dealer_filter]' );
